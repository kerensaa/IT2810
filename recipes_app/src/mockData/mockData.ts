export const mockUsers = [
  {
    ...
    reviewCount: "4",
    instructions:
      "Toss 2 cups berries with sugar. Let stand for 45 minutes, stirring occasionally. Transfer b...",
    time: "PT24H45M",
  },
  {
    id: 2,
    ...
    ingredients:
      '"sugar", "margarine", "egg", "flour", "salt", "buttermilk", "graham cracker crumbs", "margarine"',
    description:
      "I copied this one out of a friends book so many moons ago that I cant remember where its from, bu...",
    icon_path:
  ...
  },
  {
    ...
    reviewCount: "1",
    instructions:
      '"Graham Cracker Crust: In small bowl, combine graham cracker crumbs, sugar and butter. Press ev...',
    time: "PT1H15M",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    ingredients:
      '""flour"", ""sugar"", ""baking powder"", ""salt"", ""eggs"", ""vanilla"", ""egg"", ""water""',
